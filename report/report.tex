...
that F-scores of GM-bag abd GM-vote both outperform other supervised learning algorithms, except XGBoost. Nevertheless, our GM-xgb performs the best among all algorithms and achieves the highest F-score on both validation and test set!
